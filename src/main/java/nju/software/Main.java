...
public class Main implements Serializable{
    ...
    public void cal(){
        ...
        File file = new File("/home/hong/clustering.log") ;
        FileUtil.writwLog(file,new Date().toString()+": begin\n");
...
//        }
    ...
    class Users implements Serializable {
        ...
        public List<LabeledPoint> createLP(List<String> shopIdList){
            File file = new File("/home/hong/user.txt" );
            ...
            for(String userId:user.keySet()){
                ...
                FileUtil.writwLog(file,"userID:"+userId+":    "+values.toString());
